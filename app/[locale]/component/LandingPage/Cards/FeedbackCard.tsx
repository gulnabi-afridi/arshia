...
const FeedbackCard = () => {
  return (
    <div className='w-full grid gap-3 grid-cols-[80px,1fr] bg-white-1 rounded-[10px] feedbackSha p-4'>
      {/* left portion --->  */}
      ...
      <div className='flex flex-col w-full gap-3'>
        <div className='w-full flex justify-between items-start'>
          <div className='flex flex-col gap-1'>
            <p className='text-[18px] font-semibold text-purple-1'>Arshia</p>
          ...
          <p className='text-[16px] text-black-3 font-normal'>2 days ago</p>
        </div>
        {/* context -->  */}
