...
const Hero = () => {
  ...
  return (
    <div className="w-full xl:py-4 py-10 min-h-[calc(100vh-54px)] md:h-[calc(100vh-70px)] clg:min-h-[calc(100vh-90px)] bg-[url('/assets/heroBg.svg')] bg-cover bg-center overflow-x-hidden">
